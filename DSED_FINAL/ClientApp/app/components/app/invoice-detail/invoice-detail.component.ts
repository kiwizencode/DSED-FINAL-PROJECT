...
export class InvoiceDetailComponent implements OnInit {
    ...
    loadInvoices(): void {
        this.crud_Service.submit(REST_API_URI.INVOICES, CRUD_Operation.retreive).subscribe( 
            result => { 
    ...
    loadInvoiceDetails(id:number) : void {
        this.crud_Service.submit(REST_API_URI.INVOICES_DETAILS, CRUD_Operation.retreive).subscribe( 
            result =>{
