...
namespace DSED_FINAL.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPk,Name,Address01,Address02,Address03,Phone,Fax")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPk,Name,Address01,Address02,Address03,Phone,Fax")] Supplier supplier)
        {
            if (id != supplier.IdPk)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!SupplierExists(supplier.IdPk))
                    {
                        return NotFound();
                    }
                    else
